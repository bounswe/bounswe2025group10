        ...
        <div className="p-4 border-t space-y-2" style={{ borderColor: currentTheme.border }}>
          ...
          <div className="relative">
            ...
            {showNotificationsMenu && (
              ...
              >
                <div className="p-3 border-b flex justify-between items-center" style={{ borderColor: currentTheme.border }}>
                  <h3 className="font-semibold" style={{ color: currentTheme.primaryText }}>{t('common.notifications', 'Notifications')}</h3>
                  {unreadCount > 0 && (
                    <button
                ...
                <div className="max-h-64 overflow-y-auto">
                  {notifications.length === 0 ? (
                    <div className="p-4 text-center text-sm opacity-70" style={{ color: currentTheme.primaryText }}>
                    ...
                    notifications.map((notification) => (
                      <div
                        key={notification.id}
                        className={`p-3 border-b last:border-0 hover:opacity-90 cursor-pointer transition-colors ${!notification.read ? 'bg-opacity-10 bg-blue-500' : ''}`}
                        style={{ borderColor: currentTheme.border }}
                        onClick={() => markAsRead(notification.id)}
                      >
                        <p className="text-sm mb-1" style={{ color: currentTheme.primaryText }}>{notification.message}</p>
